...
Timestamp: 2026-04-28T12:19:14.875Z
...
Signature Move: Agent must choose one project-specific visual, motion, typographic, or interaction move and explain why generic fallback weakens it.
Motion Signature: Agent must explain how duration, easing, choreography, and reduced-motion alternatives derive from the chosen anchorReference.
Typographic Decision: Agent must explain how display, body, metadata, and data typography roles derive from the chosen anchorReference.
